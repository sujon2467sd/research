...
<div class="row mt-3">
    <div class="col-lg-12">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form class="form-horizontal" action="{{route('update.banner.title')}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <input type="hidden" name="id" value="{{$banner_title->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="page">
                            ...
                            <option value="sponsor" {{$banner_title->page == 'sponsor'?'selected':''}}>Sponsor</option>
