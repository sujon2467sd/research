        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="">
                <!-- Logo icon --><b>
                    ...
                    <img src="{{asset($logo->logo_image??null)}}" alt="homepage" height="60px" width="170px" class="dark-logo" />
                    <!-- Light Logo icon -->
                    <img src="{{asset($logo->logo_image??null)}}" alt="homepage" height="60px" width="170px"  class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                         <!-- dark Logo text -->
