    ...
    <div class="main-content">
        ...
        <div class="rs-breadcrumbs breadcrumbs-overlay">
            <div class="breadcrumbs-img">
                <img src="{{asset($about_us->banner_image)}}" alt="Breadcrumbs Image">
            </div>
...
{{--
        <div class="container" style="min-height: 100vh;">
            <div class="row" style="padding-top: 100px !important;">
                <div class="col-lg-6 ">
                  <div class="img1">
                    <img src="{{asset($about_us->image1)}}" alt="" >
                  </div>
                </div>
                <div class="col-lg-6">
                   <h4>{{ $about_us->title }}</h4>
                   <p style="color: #000;">{!! $about_us->details1 !!}</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
                        <div class="img-part">
                            <div class="about-img-wrap">
                                <img src="{{asset($about_us->image1??null)}}" alt="Image" class="about-img-one">
                                <img src="{{asset($about_us->image2??null)}}" alt="Image" class="about-img-two d-none d-md-block">
                    ...
                    <div class="col-lg-6 pr-70 md-pr-15">
                        <div class="sec-title">
                            ...
                            <h2 class="title mb-17">{{$about_us->title??null}}</h2>
                            {!! $about_us->details1??null !!}
                        </div>
                    </div>
                </div>
            </div>
